...
(defconst p4_16-font-lock-keywords
  (list
   ...
   (cons "[^_A-Za-z0-9]\\(\\([0-9]+w\\)?0b[01_]+\\)"        '(1 font-lock-constant-face))
   (cons "[^_A-Za-z0-9]\\(\\([0-9]+w\\)?0o[0-7_]+\\)"        '(1 font-lock-constant-face))
   (cons "[^_A-Za-z0-9]\\(\\([0-9]+w\\)?0d[0-9_]+\\)"        '(1 font-lock-constant-face))
   (cons "[^_A-Za-z0-9]\\(\\([0-9]+w\\)?0x[0-9A-Fa-f_]+\\)" '(1 font-lock-constant-face))
   (cons "[^_A-Za-z0-9]\\([+-]?\\([0-9]+w\\)?[0-9_]+\\)"    '(1 font-lock-constant-face))
