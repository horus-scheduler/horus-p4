...
class LeafController():
    ...
    def init_tables(self):
        ...
        self.get_cluster_num_valid.info.key_field_annotation_add("hdr.saqr.pool_id", "vcid")
        ...
        self.set_queue_len_unit.info.key_field_annotation_add("hdr.saqr.pool_id", "vcid")
    ...
    def set_tables(self):
        for leaf_id in range(self.NUM_LEAVES):
            ...
            self.set_queue_len_unit.entry_add(
                    self.target,
                    [self.set_queue_len_unit.make_key([client.KeyTuple('hdr.saqr.pool_id', leaf_id)])],
            ...
            self.get_cluster_num_valid.entry_add(
                self.target,
                [self.get_cluster_num_valid.make_key([client.KeyTuple('hdr.saqr.pool_id', leaf_id)])],
    ...
    def set_tables(self):
        ...
        for idx, leaf_id in enumerate(self.initial_node_list):
            self.get_rand_leaf_id_1.entry_add(
                self.target,
                [self.get_rand_leaf_id_1.make_key([client.KeyTuple('saqr_md.random_ds_index_1', idx), client.KeyTuple('hdr.saqr.pool_id', TEST_VIRTUAL_POOL_ID)])],
            ...
            self.get_rand_leaf_id_2.entry_add(
                self.target,
                [self.get_rand_leaf_id_2.make_key([client.KeyTuple('saqr_md.random_ds_index_2', idx), client.KeyTuple('hdr.saqr.pool_id', TEST_VIRTUAL_POOL_ID)])],
        ...
        self.get_cluster_num_valid.entry_add(
                self.target,
                [self.get_cluster_num_valid.make_key([client.KeyTuple('hdr.saqr.pool_id', self.TEST_VIRTUAL_POOL_ID)])],
